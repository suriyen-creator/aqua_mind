...
### แพลตฟอร์มเฝ้าระวังสภาพแวดล้อมชายฝั่งด้วย Weather/Ocean, Sentinel-2, XGBoost, SHAP และกฎแนะนำการตรวจน้ำ

**ชื่อภาษาอังกฤษ:** AquaMind: Weather-first Coastal Environmental Watch with Sentinel-2 Evidence and Explainable AI
...
| เวอร์ชัน | 2.1 — Weather-first unified system |
| วันที่จัดทำ | 17 กรกฎาคม 2569 |
| สถานะระบบที่รายงาน | MVP ใช้ Weather/Ocean API จริงเป็นข้อมูลหลักทุกพื้นที่, Sentinel-2 เป็นหลักฐานรอง และแสดง Environmental Watch index ผ่าน XGBoost + SHAP + Rule layer |
...
| สถานะเมื่อไม่มีภาพ | Environmental Watch index ยังทำงานจาก Weather/Ocean และลด Evidence completeness เหลือ 75/100; ยังไม่อ้างความแม่นยำของ Operational Bloom prediction |

> **หมายเหตุสำคัญ:** ค่าที่ระบบปัจจุบันแสดงเป็น **ดัชนีเฝ้าระวังสภาพแวดล้อม 0–100** จาก Input จริง ไม่ใช่เปอร์เซ็นต์โอกาสเกิดแพลงก์ตอนบลูม XGBoost รุ่นปัจจุบันเรียนเลียนแบบกฎที่เปิดเผยเพื่อให้ SHAP อธิบายได้ ส่วน Operational Bloom probability และการกล่าวอ้างความแม่นยำภาคสนามยังถูกระงับจนกว่าจะมี Ground Truth และผ่าน Validation
...
2. ตรวจป้ายและข้อความว่าเป็น `Weather-first Live Environmental Watch`
3. อ่านข้อความกำกับว่าดัชนี `/100` ไม่ใช่เปอร์เซ็นต์โอกาสเกิดแพลงก์ตอนบลูม
