...
![ภาพที่ 7-1 หน้า Streamlit Cloud ที่ Deploy จริง แสดง Bangsaen Live Data Readiness และ XGBoost + SHAP Synthetic Technical Demo](docs/images/streamlit_live_readiness.png)

**ภาพที่ 7-1** หน้า Streamlit Cloud ที่ Deploy จริง ณ วันที่ 17 กรกฎาคม 2569 ส่วนบนแสดงข้อมูล Sentinel-2, NDCI/NDWI, สัดส่วนพิกเซลน้ำที่ผ่าน QC และข้อมูลสมุทรศาสตร์ล่าสุด ส่วนข้อความเตือนระบุชัดว่าระบบพบ Ground truth ที่ยืนยันแล้ว 0 แถว จึงระงับ Operational probability และใช้ Weather/Ocean เป็นบริบทการพยากรณ์สิ่งแวดล้อม พร้อมใช้ Sentinel-2 เป็นหลักฐานประกอบเท่านั้น ส่วน XGBoost + SHAP ด้านล่างระบุเป็น Synthetic Technical Demo ไม่ใช่ค่าความเสี่ยงจริงของบางแสน
