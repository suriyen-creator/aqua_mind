...
กลุ่มที่ต้องสัมภาษณ์แยกกันคือเกษตรกรรายย่อย ฟาร์มขนาดใหญ่ สหกรณ์ เจ้าหน้าที่ประมง หน่วยงานท้องถิ่น และผู้ซื้อ B2B แต่ละกลุ่มอย่างน้อย 5–10 รายในระยะค้นหาปัญหา การทดสอบ SUS 30 รายใช้วัด Usability เท่านั้น ไม่ใช้ยืนยัน Product–market fit
...
| รายการ | ค่าที่ต้องกรอกก่อนเปิด Test set |
|---|---|
| นิยาม Outcome/Label | [กรอก] |
| Lead horizons | t+1, t+2, t+3, t+4, t+5 หรือ [กรอก] |
| Independent event count | [กรอก] |
| Spatial/temporal split rule | [กรอก] |
| Full model features | [กรอก] |
| No-image model features | [กรอก] |
| ห้ามใช้ข้อมูลใดเพราะ Leakage | [กรอก] |
| Data-age buckets | [กรอกตามข้อมูล ไม่สมมติจาก UI] |
| Recall gate ต่อ bucket | [กรอก] |
| Precision gate ต่อ bucket | [กรอก] |
| Calibration/Brier/ECE gate | [กรอก] |
| วิธี Paired bootstrap/CI | [กรอก] |
| Missing/cloud stress-test period | [กรอก] |
| Suppression behavior | `risk_probability=null` + reason + local confirmation |
| ผู้อนุมัติเปิดใช้แต่ละ Mode | [กรอก] |
...
|---|---|---:|---|---|---|---|
| Problem interview | [กรอก] | [กรอก] | [กรอก] | [กรอก] | Note/recording ตาม Consent | Continue/Pivot/Stop |
| Workflow observation | [กรอก] | [กรอก] | [กรอก] | [กรอก] | Time/action log | Continue/Pivot/Stop |
| Price test | [กรอก] | [กรอก] | [กรอก] | [กรอก] | Offer/LOI/payment | Continue/Pivot/Stop |
| Paid pilot | [กรอก] | [กรอก] | [กรอก] | [กรอก] | Contract/invoice | Continue/Pivot/Stop |
...
|---|---:|---:|---:|
| จำนวนฟาร์มที่จ่าย | [กรอก] | [กรอก] | [กรอก] |
| รายได้จริงต่อฟาร์ม/เดือน | [กรอก] | [กรอก] | [กรอก] |
| Compute/data cost ต่อฟาร์ม | [กรอก] | [กรอก] | [กรอก] |
| Notification/support ต่อฟาร์ม | [กรอก] | [กรอก] | [กรอก] |
| Field/lab cost ที่โครงการรับ | [กรอก] | [กรอก] | [กรอก] |
| CAC | [กรอก] | [กรอก] | [กรอก] |
| Sales cycle | [กรอก] | [กรอก] | [กรอก] |
| Seasonal retention/churn | [กรอก] | [กรอก] | [กรอก] |
| Gross/contribution margin | [คำนวณ] | [คำนวณ] | [คำนวณ] |
| Runway | [คำนวณ] | [คำนวณ] | [คำนวณ] |
...
|---|---|---|---|---|
| ไม่มีภาพใช้ได้ | Satellite age/valid pixel ratio | [กรอก] | No-image gate/Suppression | เกิน Maximum validated age |
| Metric/Calibration drift | Drift/Brier/ECE | [กรอก] | Retrain/rollback | เกิน Threshold |
| Alert ส่งไม่ถึง | Delivery/ack rate | [กรอก] | Retry/ช่องทางสำรอง | ไม่ Ack ภายใน SLA |
| External provider ล่ม | Error/latency/quota | [กรอก] | Cache/adapter/replacement | เกิน Provider SLA |
| Ground Truth ปนเปื้อน | Verification/reject/duplicate rate | [กรอก] | Reviewer workflow | เกิน QC threshold |
| Privacy/security incident | Security alerts | [กรอก] | IR plan/least privilege | ตาม Incident severity |
| Cost สูงผิดปกติ | Cost per farm/alert | [กรอก] | Budget/rate limit | เกิน Budget threshold |
| คำแนะนำก่อผลเสีย | Incident/complaint | [กรอก] | Expert protocol/audit | หยุด Recommendation mode |

### ช.2 Provider register ขั้นต่ำ

| Provider | Data/Service | SLA/Latency | Quota | Cost | Terms/License | Retention | Replacement | Owner |
|---|---|---|---|---|---|---|---|---|
| Google Earth Engine/Sentinel-2 | Imagery/processing | [กรอก] | [กรอก] | [กรอก] | [ตรวจ] | [ตรวจ] | [กรอก] | [กรอก] |
| Weather provider | Forecast | [กรอก] | [กรอก] | [กรอก] | [ตรวจ] | [ตรวจ] | [กรอก] | [กรอก] |
| Copernicus Marine | Regional SST | [กรอก] | [กรอก] | [กรอก] | [ตรวจ] | [ตรวจ] | [กรอก] | [กรอก] |
| Map provider | Basemap | [กรอก] | [กรอก] | [กรอก] | [ตรวจ] | [ตรวจ] | [กรอก] | [กรอก] |
| SMS/LINE/Email | Alert | [กรอก] | [กรอก] | [กรอก] | [ตรวจ] | [ตรวจ] | [กรอก] | [กรอก] |
